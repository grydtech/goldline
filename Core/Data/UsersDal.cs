...
namespace Core.Data
{
    internal class UsersDal : Dal
    {
        public UsersDal(IDbConnection connection) : base(connection)
        {
        }
        ...
        public User GetUser(string username, string password)
        {
            ...
            var command = new CommandDefinition(
                "select id_employee 'EmployeeId', type_user-1 'UserType', username 'Username', password 'Password' " +
        ...
        public void UpdateUserType(User user, UserType newUserType)
        {
            // Define sql command
            var command = new CommandDefinition(
        ...
        public void InsertUser(User user)
        {
            ...
            var command = new CommandDefinition(
                ...
                {
                    id_employee = user.EmployeeId,
                    type_user = user.UserType.ToString(),
